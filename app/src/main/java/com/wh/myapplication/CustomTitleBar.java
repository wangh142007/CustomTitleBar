    ...
    public CustomTitleBar(Context context, AttributeSet attrs) {
        ...
        if (attributes != null) {
            ...
            if (leftButtonDrawable != -1) {
                Drawable drawableAttention = getResources().getDrawable(leftButtonDrawable);
                drawableAttention.setBounds(0, 0, 40, 40);
                titleBarLeftBtn.setCompoundDrawables(null, drawableAttention, null, null);  //设置到哪个控件的位置（）
            }
            ...
            if (rightButtonDrawable != -1) {
                Drawable drawableAttention = getResources().getDrawable(rightButtonDrawable);
                drawableAttention.setBounds(0, 0, 40, 40);
                titleBarRightBtn.setCompoundDrawables(null, drawableAttention, null, null);  //设置到哪个控件的位置（）
